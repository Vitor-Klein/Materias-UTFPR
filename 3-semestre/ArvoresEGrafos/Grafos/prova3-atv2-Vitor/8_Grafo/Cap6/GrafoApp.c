...
void main(){
    ...
    do{
        ...
        printf(" 10 - Verifica se o grafo é Hamiltoniano \n");
        printf(" 11 - Verifica se o grafo é Euleriano \n");
        printf(" 12 - Sair \n");
...
//----------------------------------------------------
        case 10 :
            if (verificaHamiltoniano(grafo, comparaVertice)) {
